<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ver.aspx.cs" Inherits="Aoniken_Posts.Forms.Editor.Ver" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
            <div class="col-sm-12">
            <label>Autor:</label>
            <asp:Label runat="server" ID="lblAutor"></asp:Label>
                </div>
        </div>
